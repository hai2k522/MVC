...
<head>
    ...
    <link rel="stylesheet" href="http://localhost:8080/73DCTT24_MVC/Public/Css/bootstrap.min.css">
    <link rel="stylesheet" href="http://localhost:8080/73DCTT24_MVC/Public/Css/dinhdang7.css">
    <script src="http://localhost:8080/73DCTT24_MVC/Public/Js/jquery-3.3.1.slim.min.js"></script>
    <script src="http://localhost:8080/73DCTT24_MVC/Public/Js/popper.min.js"></script>
    <script src="http://localhost:8080/73DCTT24_MVC/Public/Js/bootstrap.min.js"></script>
</head>
<body>
    <div class="container-fluid">
        <div class="header1">
            <img src="http://localhost:8080/73DCTT24_MVC/Public/Pictures/logo.png" alt="">
        </div>
                        ...
                        <td style="width: 20%; vertical-align: top;padding-left: 15px;">
                            <div class="list-group">
                                ...
                                <div class="collapse" id="target1">
                                    ...
                                    <a href = "http://localhost:8080/73DCTT24_MVC/Tacgia" class = "list-group-item">Tác giả</a>
                                    <a href = "http://localhost:8080/73DCTT24_MVC/Danhsachtacgia" class = "list-group-item">Danh sách tác giả</a>
                                    <a href = "http://localhost:8080/73DCTT24_MVC/Nhaxuatban_file" class = "list-group-item">Nhà xuất bản</a>
                                </div>
